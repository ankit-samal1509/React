...
function Card({userName, btnText = "click me", image = "https://picsum.photos/400/300?random=90" }) {
    return (
        <div className="md:max-w-sm w-full p-6 m-2 rounded-xl shadow-xl bg-black border border-zinc-800 hover:border-white transition-all duration-300 hover:transform hover:scale-105 group">
